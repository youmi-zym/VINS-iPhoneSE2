...
- (void)viewDidLoad {
    ...
    if(!deviceCheck)
    {
        UIAlertController *alertDevice = [UIAlertController alertControllerWithTitle:@"Unsupported Device"
                                                                             message:@"Supported devices are: iPhone7 Plus, iPhone7, iPhone6s Plus, iPhone6s iPhoneSE2" preferredStyle:UIAlertControllerStyleAlert];
...
DeviceType deviceName()
{
    ...
    else if(([device compare:@"iPhone12,8"] == NSOrderedSame))
    {
        printf("Device iPhoneSE2\n");
        device_type = iPhoneSE2;
    }
